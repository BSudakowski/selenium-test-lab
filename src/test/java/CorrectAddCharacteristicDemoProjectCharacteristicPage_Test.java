...
public class CorrectAddCharacteristicDemoProjectCharacteristicPage_Test {
    ...
    public void CorrectAddCharacteristicDemoProjectCharacteristicTable() {
        ...
        //Assert
        WebElement characteristicsView = driver.findElement(By.cssSelector(".table-responsive"));
